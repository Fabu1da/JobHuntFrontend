...
export const JobContainer = () => {
    ...
    const { allJobs, profile, currentFilter, isLoading, error } = useFilterContext();
              ...
              return (
                <div key={job.id} className={`job-card ${scoreClass}`}>
                  ...
                  <div className="job-meta-line">
                    ...
                    <span className="meta-type">{job.job_type || 'Not specified'}</span>
                    <span className="meta-separator">·</span>
                    <span className="meta-location">{job.location || 'Not specified'}</span>
                    <span className="meta-separator">·</span>
                    <span className={`source-badge ${sourceClass}`}>{job.site || 'job board'}</span>
                    <span className="meta-separator">·</span>
                    <span className="meta-salary">{job.Salary_target || 'Not specified'}</span>
